 ...
 *
 */
public class UIMenuItem extends AbstractGameObject implements UIComponent {
	...
	public void draw(Game game, Graphics2D g) {
		super.draw(game, g);
		this.rect = RenderHelper.drawShadowString(g, 
				getLabel(), 
				(int) x, (int) y, 
				drawColor, 
				menu.getShadowColor(),
				(textPosition != null ? textPosition : TextPosition.LEFT), 
				2);
	}
