...
public class DynamicGameObject extends AbstractGameObject {
    ...
    /**
     * acceleration parameters for this object.
     */
    public float ax = 0.0f, ay = 0.0f;
    ...
    /**
     * Elasticity factor for collision response computation.
     */
    public float elasticity = 0.45f;


    /**
     * Animation and physic behavior attributes.
     */
    public Actions action = Actions.IDLE;
    /**
     * Animation and physic behavior attributes.
     */
    public Actions previousAction = Actions.IDLE;
    ...
    public void update(Game game, long dt) {
        ...
        dx += (ax * dt);
        // gravity added to the vertical acceleration.
        dy += ((ay + gravity) * dt);
